...
const DEMO_STEPS: ReasoningStep[] = [
  { type: 'step_complete', step: 'alert_intake', label: 'Alert received', elapsed: 0.8,
    title: 'Incident Detected', time: '09:42:10 AM', desc: 'Incident detected a checkout failure.', icon: 'alert', status: 'COMPLETE/ACTIVE',
  ...
  { type: 'step_complete', step: 'log_analysis', label: 'Reading error logs', elapsed: 1.4,
    title: 'Ingesting Logs', time: '09:42:15', desc: 'Ingesting logs form in-commerce logs.', icon: 'db', status: 'COMPLETE/ACTIVE',
  ...
  { type: 'step_complete', step: 'commit_analysis', label: 'Metric Analysis', elapsed: 2.1,
    title: 'Metric Analysis', time: '09:42:25', desc: 'Analysis analysis-analysis metric melyvis.', icon: 'chart', status: 'COMPLETE/ACTIVE',
  ...
  { type: 'step_complete', step: 'pr_diff_analysis', label: 'Pattern Recognition', elapsed: 2.9,
    title: 'Pattern Recognition', time: '09:42:38', desc: 'Pattern recognition for some rontognifiea.', icon: 'pulse', status: 'COMPLETE/ACTIVE',
  ...
  { type: 'step_complete', step: 'dependency_detection', label: 'Identifying Anomaly', elapsed: 3.6,
    title: 'Identifying Anomaly', time: '09:42:50', desc: 'Identifying anomaly anomaly.', icon: 'triangle', status: 'COMPLETE/ACTIVE',
  ...
  { type: 'step_complete', step: 'call_site_analysis', label: 'Correlating Events', elapsed: 4.3,
    title: 'Correlating Events', time: '09:43:05', desc: 'Correlating Events: correlating events.', icon: 'nodes', status: 'COMPLETE/ACTIVE',
  ...
  { type: 'step_complete', step: 'hypothesis_formation', label: 'Tracing Dependencies', elapsed: 5.1,
    title: 'Tracing Dependencies', time: '09:43:20', desc: 'Tracing depend to tracing dependencies.', icon: 'tree', status: 'COMPLETE/ACTIVE',
  ...
  { type: 'step_complete', step: 'confidence_scoring', label: 'Hypothesizing Root Cause', elapsed: 5.8,
    title: 'Hypothesizing Root Cause', time: '09:43:38', desc: 'Hypothesizing root cause, root chewse.', icon: 'search', status: 'COMPLETE/ACTIVE',
  ...
  { type: 'step_complete', step: 'fix_generation', label: 'Simulating Impact', elapsed: 6.2,
    title: 'Simulating Impact', time: '09:44:00', desc: 'Simulating Impact to simulating Impact.', icon: 'simulate', status: 'COMPLETE/ACTIVE',
  ...
  { type: 'step_complete', step: 'cascade_mapping', label: 'Recommended Actions', elapsed: 6.8,
    title: 'Recommended Actions', time: '09:44:20', desc: 'Recommended actions to remenned actions.', icon: 'alert', status: 'COMPLETE/ACTIVE', isFinal: true,
